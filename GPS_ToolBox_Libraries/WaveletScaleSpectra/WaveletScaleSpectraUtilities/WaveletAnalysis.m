function [SPEC_Summary,xscale,nskip,wc,qmf,J]=WaveletAnalysis(data,dx,jmin,Family,varargin)
...
%Rino Consulting
%January 2012 
%Revised August 2012, November 2014
%crino@comcast.com
...
if DISP~=0
    ...
    for nseg=nskip/2:nskip:nsamp
        ...
        if mod(nn,nmod)==0
            hold on
            text(x_data_ext(nseg)*scale,log10(qScale(1)),num2str(nn))
        end
    end
    bold_fig
end
